...
\newglossaryentry{gen vel}
{
    ...
    description={The generalized velocity is the time derivative of the generalized coordinate. These can be translational or rotational velocities, or have units which are not typical for a velocity}
}

\newglossaryentry{generalized coordinate}
{
    name=generalized coordinate,
    first = {\textit{generalized coordinate}},
    plural = {generalized coordinates},
    firstplural = {\textit{generalized coordinate}},
    description={A free direction of movement for a vehicle. These can be translational or rotational directions, or have any units. A generalized coordinate just defines some aspect of the system state}
}
...
\newglossaryentry{wave drag}
{
    name=wave drag,
    first={\textit{wave drag}},
    description={A type of drag associated with supersonic flow which is caused by the formation of shock waves and pressure differences}
}
