...
The Phial is hanging from a chain. The dynamics of the system can be modelled as a double pendulum with two rigid arms, both of length $L$, which are free to rotate in the $xy$-plane. Find the \gls{eom} for the system.
...
\begin{gather}
    ...
    \end{bmatrix}}\\\color{blue}\mathrm{Relating\ Angular\ Velocity\ to\ Euler\ Rates}
\end{gather}
\begin{gather}
