...
\lstinputlisting[style = matlab-editor, language=Matlab, caption=Problem 4-2 Solution Code]{6DoF Explanation Scripts/Example Problems/P4_2_Script.m}\label{P4-2 Solution Code}
