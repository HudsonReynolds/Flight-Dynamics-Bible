...
Our initialization of the \gls{state vector} and all of the basic setup in contained in the main file, shown in \autoref{code:DzhanMain}. The code that gets the derivative of the \gls{state vector} is the function passed into ode45. This code is shown in listing \autoref{code:DzhanInt}. There is additionally a file to display the rotation of the body in an animation, which is shown in \autoref{code:DzhanRotVis}.
...
\chapter*{Appendix A: Answers to Selected Problems}

\chapter*{Appendix B: Proofs and Derivations}\label{sec:ProofsAndDerivations}
