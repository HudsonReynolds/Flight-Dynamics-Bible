...
\begin{itemize}
    \item Improve parachute modeling (multibody)
    \item Improve readabillity of 6-DoF
    \item Update Confluence
...
For those interested in control system design and analysis, we recommend \autoref{sec: Newtonian Dynamics}, \autoref{sec:energy methods}, Part V of Volume II, and Volume III (with an emphasis on Part III).
...
\item You find yourself flying a UH-1 Huey over Hamburger Hill in Vietnam, 1969. While preparing to land on your medevac mission, you glance at your inertial navigation system and are horrified to find it has been blown away by a RPG-7! You must now make the calculations necessary to determine how much of your thrust will be acting directly along the ground. Should this force exceed 1,000 N, the soldiers on the ground will be blown away. You decide to utilize a rotation sequence identical to what was used on the navigation system: a 3-2-1 sequence. With this, you determine the Euler angles to be 0.1, 0.15, and -0.1 radians, and the force of the engine is known to be 40,000 N. Will the soldiers go tumbling away as you land? A view of what you see with the reference frames imposed on it is shown below:
...
In this final chapter, we discuss the techniques and practices for implementing a 6-DoF in MATLAB. We will also discuss more general practices for large MATLAB code bases and methods to keep these organized. As of late June 2025, these practices are currently being implemented on our 6-DoF model. A large portion of the content in this chapter comes from what we have seen as practices adopted in industry for systems much more complex and larger than our own.
...
\subsection{Objects, Properties, and Methods}
...
Another useful property of classes which is demonstrated  here is input validation. Input validation allows us to ensure that the input into a class or one of its methods is of a certain type. In this example, the "name" can only be a "string" of size 1 (scalar).
