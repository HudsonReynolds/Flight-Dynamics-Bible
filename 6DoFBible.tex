...
The solving of these $\Pi$ groups is shown in the Appendix in \autoref{Buckingham Pi Deriv} because it is quite lengthy.
...
In this section we will combine everything from the previous sections and explain how our 6-\gls{dof} model works. We will follow a similar set up to \autoref{sec:Dzhan}  here, describing the elements of the model in detail and then attaching relevant code either in-line or in the appendix.
