...
\end{enumerate}
\item You find yourself flying a UH-1 Huey over Hamburger Hill in Vietnam circa 1969. While preparing to land on your medevac mission, you glance at your inertial navigation system and are horrified to find it has been blown away by a RPG-7! You must now make the calculations necessary to determine how much of your thrust will be acting directly along the ground. Should this force exceed 1,000 N, the soldiers on the ground will be blown away. You decide to utilize a rotation sequence identical to what was used on the navigation system: a 3-2-1 sequence. With this, you determine the Euler angles to be 0, 0.15, and -0.05 radians respectively, and the force of the engine is known to be 10,000 N. Will the soldiers go tumbling away as you land? A view of what you see with the reference frame imposed on it is shown below:
\begin{figure}[H]
    \centering
...
\end{figure}
The reference frame shown above is identical to the inertial frame for simplicity.
